...
def _strip_unverified_markers(text: str, verified: set[str]) -> str:
    """
    Remove inline citation markers that did not survive verification, leaving
    non-citation brackets (e.g. [PRIMARY]) untouched. Collapses any double
    spaces left behind.
    """
    def _replace(match: re.Match) -> str:
        ...
        return match.group(0) if token in verified else ""
